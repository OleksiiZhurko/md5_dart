...
/// MD5 hash
///
/// Able to compute hash from strings up to 2^63-1
class MD5 {
  static const int _ZERO        = 0;
  static const int _ONE         = 1;
  static const int _TWO         = 2;
  static const int _THREE       = 3;
  static const int _FOUR        = 4;
  static const int _EIGHT       = 8;
  static const int _SIXTEEN     = 16;
  static const int _TWENTY_FOUR = 24;

  static const int _BINARY = 2;
  static const int _HEXADECIMAL = 16;

  static const int _INT_32 = 32;

  static const int _BITS_448 = 56;
  static const int _BITS_512 = 64;

  /// Needed to fill the line
  static const String _AGGREGATE = '0';
  ...
  static const List<Function> _functions = [_funcF, _funcG, _funcH, _funcI];
  ...
  @visibleForTesting
  static List<int> align(List<int> bytes) {
  ...
  static List<int> _bytesToUintArr(List<int> bytes) {
  ...
  ///
  /// Returns a [String] of the input array in hex hash representation
  static String _produceHash(List<int> bytes) {
    int aa, bb, cc, dd, i;
  ...
  @visibleForTesting
  static String produceLittleEndianUint32Hex(int n) =>
  ...
  @visibleForTesting
  static String alignHexIn8(String hex, [int len = _EIGHT]) =>
  ...
  @visibleForTesting
  static int rotateLeftInt(int n, int shift, [int intNum = _INT_32]) =>
  ...
  static String _produceLittleEndianMD5Answer(int a, int b, int c, int d) =>
  ...
  static List<int> _appendLittleEndian(List<int> bytes, int n) =>
  ...
  static int _funcF(int x, int y, int z) => (x & y) | (~x & z);
  ...
  ///
  /// Returns a computed [int]
  static int _funcG(int x, int y, int z) => (x & z) | (~z & y);
  ...
  ///
  /// Returns a computed [int]
  static int _funcH(int x, int y, int z) => x ^ y ^ z;
  ...
  ///
  /// Returns a computed [int]
  static int _funcI(int x, int y, int z) => y ^ (~z | x);
}
